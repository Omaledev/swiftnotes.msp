    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        ...
        <div class="px-4 py-5 sm:p-6">
            ...
            <form method="POST" action="{{ route('settings.update') }}">
                ...
                <div class="mb-4">
                    <label for="current_password" class="block text-sm font-medium text-gray-700">Current Password (for password change)</label>
                ...
                <div class="mb-4">
                    ...
                    <input type="password" id="new_password_confirmation" name="new_password_confirmation" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                </div>
